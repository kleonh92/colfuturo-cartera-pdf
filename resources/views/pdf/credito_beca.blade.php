                ...
                <tr style="vertical-align: top;">
                    ...
                    <td>
                        ...
                        @if($creditArrear = $creditos['01']['inicio'][0]['creditArrear'])
                            <div class="font-roboto font-medium text-base">Crédito <span class="text-color-primary">en mora</span></div>
                        ...
                        <table style="width:auto;" class="font-roboto-condensed font-normal text-base">
                            <tr class="bg-neutral-50">
                                ...
                                <td style="width:121px;" class="pl-1 pt-1 pb-1 ">{{ \App\Helpers\GicDataFormatter::formatDate($creditos['01']['inicio'][0]['nextPaymentDate']) }}</td>
                            </tr>
                            <tr class="bg-neutral-50">
                                <td class="pl-1 pt-1 pb-1 "><b>Pago sugerido</b></td>
                                <td class="pl-1 pt-1 pb-1 "><b>USD {{ \App\Helpers\GicDataFormatter::formatNumber($creditos['01']['inicio'][0][$creditArrear ? 'amountSuggestedArrear' : 'amountSuggested']) }}</b></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td class="pr-20">
                        ...
                        <table style="width:auto" class="font-roboto-condensed border-separate border-spacing-1 text-base">
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td class="font-roboto-mono font-medium">+ {{ $resumen['months'] }} meses</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>

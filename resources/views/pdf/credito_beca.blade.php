...
<body>
            ...
            <tr>
                ...
                <td width="35%">
                    <ul class="list-style-none">
                        <li><small class="font-roboto font-medium text-color-primary text-base">{{ implode(' ', [$beneficiario['name'], $beneficiario['lastname']]) }}</small></li>
                        <li><small class="font-roboto font-normal text-sm text-neutral-90">{{ $beneficiario['program'] }}</small></li>
                        <li><small class="font-roboto font-normal text-sm text-neutral-90">{{ $beneficiario['university'] }}</small></li>
                    </ul>
                </td>
                <td width="35%">
                    <ul class="list-style-none">
                        <li><small class="font-roboto font-normal text-sm text-neutral-80">CC: <span class="font-medium text-neutral-90">{{ number_format($beneficiario['identification'], 0, ',', '.') }}</span>
                            </small> </li>
                        <li><small class="font-roboto font-normal text-sm text-neutral-80">Código: <span class="font-medium text-neutral-90">{{ number_format($beneficiario['disbursementCode'], 0, ',', '.') }}</span></small></li>
                        <li><small class="font-roboto font-normal text-sm text-neutral-80">Estado: <span class="font-medium text-neutral-90">{{ $beneficiario['statusName'] }}</span></small></li>
                    </ul>
                </td>
                <td width="20%">
                    <ul class="list-style-none">
                        ...
                        <li style="vertical-align: middle; display:block;  margin-bottom:0px;">
                            <small class="font-roboto-condensed font-normal text-sm text-neutral-100">
                                <a href="#content-table" class="text-neutral-100"><span class="point" style="background: #000000"></span>Contenido</a>
                            </small>
                        </li>

                        <li style="vertical-align: middle; display:block;  margin-bottom:0px;">
                            <small class="font-roboto-condensed font-normal text-sm text-blue-500">
                                <a href="#extracto-credito" class="text-blue-500"><span class="point" style="background: #3f83f8"></span>Extracto Crédito</a>
                            </small>
                        </li>

                        <li style="vertical-align: middle; display:block; margin-bottom:0px;">
                            <small class="font-roboto-condensed font-normal text-sm text-yellow-500">
                                <a href="#extracto-beca" class="text-yellow-500"><span class="point" style="background: #c27803"></span>Extracto Beca</a>
                            </small>
                        </li>
    ...
    <footer style="margin-left:70px; margin-right:70px;" class="border-top">
        <table>
            <tr>
                <td width="40%" class="font-roboto-mono text-base font-normal">Extracto Crédito Beca COLFUTURO. Corte al {{ \App\Helpers\GicDataFormatter::formatDate($beneficiario['cutoffDate']) }}</td>
                <td width="20%" class="font-roboto-mono text-base font-normal text-center"><b class="page-count"></b></td>
                <td width="40%" class="font-roboto-mono text-base font-normal text-right">Generado el {{ Carbon\Carbon::now('America/Bogota')->format('d M Y, H:i') }}</td>
            </tr>
        </table>
    </footer>
    ...
    <main style="margin-left:70px; margin-right:70px;">
                    ...
                    <td width="50%" class="pr-40">
                        ...
                        <table class="ml-20 table-stripped text-base border-separate border-spacing-1 table-p-1">
                            ...
                            <tr class="font-roboto-condensed font-normal text-center">
                                ...
                                <td style="width:92px;">USD</td>
                                <td style="width:90px;">USD</td>
                            ...
                            <tr class="font-roboto-condensed font-normal {{ $resumen[$key]['isDebit'] ? 'text-color-primary' : '' }}">
                                ...
                                <td class="font-roboto-mono text-center">{{ \App\Helpers\GicDataFormatter::formatNumber($resumen[$key]['amountForgiveness'], $resumen[$key]['isDebit']) }}</td>
                                <td class="font-roboto-mono text-center">{{ \App\Helpers\GicDataFormatter::formatNumber($resumen[$key]['amountForgivenessCop'], $resumen[$key]['isDebit']) }}</td>
                                @if($key === 'interests')
                    ...
                    <td>
                        ...
                        <table style="width:auto;" class="pl-20 font-roboto-condensed font-normal text-base table-p-1">
                            <tr class="bg-gray-2">
                                ...
                                <td style="width:121px;" class="font-roboto-mono text-right pl-1 pt-1 pb-1 ">{{ \App\Helpers\GicDataFormatter::formatDate($creditos['01']['inicio'][0]['nextPaymentDate']) }}</td>
                            </tr>
                            <tr class="bg-neutral-50">
                                <td class="pl-1 pt-1 pb-1 "><b>Pago sugerido</b></td>
                                <td class="font-roboto-mono text-right pl-1 pt-1 pb-1 "><b>USD {{ \App\Helpers\GicDataFormatter::formatNumber($creditos['01']['inicio'][0][$creditArrear ? 'amountSuggestedArrear' : 'amountSuggested']) }}</b></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table style="width:auto" class="ml-20 font-roboto-condensed border-separate border-spacing-1 text-base">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="font-roboto-mono font-medium">{{ \App\Helpers\GicDataFormatter::formatDate($resumen['startDateFinancing']) }}</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td class="text-neutral-80 font-normal">Fin financiación</td>
                                    <td class="border-bottom-gray font-roboto-mono font-medium">{{ \App\Helpers\GicDataFormatter::formatDate($resumen['endDateFinancing']) }}</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td class="font-roboto-mono font-medium text-right">{{ \App\Helpers\GicDataFormatter::diffDatesInMonths($resumen['endDateFinancing'], $resumen['startDateFinancing']) }} meses</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom-gray font-roboto-mono font-medium">{{ \App\Helpers\GicDataFormatter::formatDate($resumen['endDateStudies']) }}</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    <td class="text-neutral-80 font-normal">Fin financiación</td>
                                    <td class="font-roboto-mono font-medium">{{ \App\Helpers\GicDataFormatter::formatDate($resumen['endDateFinancing']) }}</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td class="font-roboto-mono font-medium text-right border-bottom-gray">+ {{ $resumen['months'] }} meses</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td style="width:106px;" class="font-roboto-mono font-medium">{{ \App\Helpers\GicDataFormatter::formatDate($resumen['maximumDatePermanence']) }}</td>
        ...
        <div class="page" style="page-break-before: always;">
            ...
            <table>
                <tr>
                    <td>
                        <h4 id="extracto-credito" class="p-0 m-0 font-roboto font-medium text-2xl text-blue-500">Extracto Crédito </h4>
                    </td>
                </tr>
                <!-- Main Layout -->
                <tr style="vertical-align:top">
                        ...
                        <table style="width:auto" class="ml-20 table-stripped table-p-1 font-roboto-condensed">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="p-1 font-roboto-mono text-right">{{ \App\Helpers\GicDataFormatter::formatPercentage($creditos['01']['inicio'][0]['currentInterest']) }}</td>
                                </tr>
                                <tr>
                                    <td class="p-1 text-center">Mora</td>
                                    <td class="p-1 font-roboto-mono text-right">{{ \App\Helpers\GicDataFormatter::formatPercentage($creditos['01']['inicio'][0]['arrears']) }}</td>
                                </tr>
                                <tr>
                                    <td class="p-1 text-center">Seguro</td>
                                    <td class="p-1 font-roboto-mono text-right">{{ \App\Helpers\GicDataFormatter::formatPercentage($creditos['01']['inicio'][0]['insurance']) }}</td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                ...
                                @foreach($creditos['01']['interesesYSeguros'] as $item)
                                    <tr>
                                        ...
                                        <td class="font-normal text-left">{{ $item['period'] }}</td>
                                        <td class="font-normal font-roboto-mono text-right">{{ \App\Helpers\GicDataFormatter::formatPercentage($item['effectiveAnnualRate'])  }}</td>
                                        <td class="font-normal font-roboto-mono text-right">{{ $item['months'] }}</td>
                                        <td class="font-normal font-roboto-mono text-right">{{ \App\Helpers\GicDataFormatter::formatNumber($item['amountUsd']) }}</td>
                                        <td class="font-normal font-roboto-mono text-right">{{ \App\Helpers\GicDataFormatter::formatNumber($item['amountSecure']) }}</td>
                                    </tr>
                                @endforeach
                                <tr class="bg-neutral-50">
                                                    ...
                                                    @foreach($desembolsosSubtable as $key => $item)
                                                        ...
                                                        @if ($loop->last && $loop->parent->last && $loop->parent->parent->last)
                                                            <tr class="bg-neutral-50">
                                                                ...
                                                                <td class="p-1 font-roboto-mono  font-bold">{{ \App\Helpers\GicDataFormatter::formatNumber($desembolsos->sum('amount')) }}</td>
                                                            </tr>
                                                        @endif
                                                    @endforeach
                                                </tbody>
                        ...
                        <table style="width:auto" class="ml-20 font-roboto-condensed">
                            <tbody>
                                <tr class="font-bold bg-neutral-50">
                                    <td></td>
                                    <td style=""   class="p-1 text-center">Inicio</td>
                                    <td style=""  class="p-1 text-center">Fin</td>
                                    <td style=""  class="p-1 text-center">Pagadas</td>
                        ...
                        <table style="width:auto;" class="mt-20 ml-20 text-base">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right font-roboto-mono font-medium border-bottom-gray"> <span>-</span> 18 meses</td>
                                </tr>
                                <tr >
                                    <td class="text-neutral-80 font-normal">Adicionales requeridos</td>
                                    <td class="text-right font-roboto-mono font-medium">18 meses</td>
                                </tr>
                            </tbody>
                        </table>
                        <!-- Fin Tabla 2, Pag 11 -->
                    ...
                    <td>
                        ...
                        <table style="width:auto;" class="mt-20 ml-20 text-base">
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-neutral-80 font-normal">Permanencia a cumplir</td>
                                    <td class="text-right font-roboto-mono font-medium">48 meses</td>
                                </tr>
                                <tr >
                                    <td class="text-neutral-80 font-normal">Reportados en Colombia</td>
                                    <td class="text-right font-roboto-mono font-medium border-bottom-gray"><span>-</span>18 meses</td>
                                    <td style="width:800px;" class="pl-1 font-roboto font-normal text-sm text-neutral-80">(Pendiente cuando considere que se cumplieron los meses de permanencia con Certificado de Movimientos Migratorios). </td>
                                </tr>
                                <tr >
                                    <td class="text-neutral-80 font-normal">Adicionales requeridos</td>
                                    <td class="text-right font-roboto-mono font-medium">30 meses</td>
                                    <td style="width:418px;" class="pl-1 font-roboto font-normal text-sm text-neutral-80">Antes de ago 2026 (tiene 48 meses más par cumplir permanencia).</td>
                                </tr>
                            </tbody>
                        </table>
                        <!-- Fin Tabla 2, Pag 11 -->
